...
class DocumentChunk(BaseModel):
    ...
    # Context
    char_start: Optional[int] = Field(None, description="Character offset in original document")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "doc_id": "kb-12345",
                "chunk_idx": 0,
                "text": "To request time off, navigate to the HR Portal and click on 'Request Leave'...",
                "source": "servicenow",
                "title": "How to Request Time Off",
                "language": "en",
                "acl_allow": ["all-employees", "uk-hr"],
